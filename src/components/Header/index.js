      ...
      <Container>
        <div className='header-inner-block'>
          <Navbar bg="dark" variant="dark">
            <Container>
              {/* <Navbar.Brand href="#home" className='col-1'>Navbar</Navbar.Brand> */}
              <span>
              ...
              <Nav className="col-9 search-bar">
              ...
              <div className='col-2 header-icon-block'>
                {/* <Button variant="outline-secondary" id="button-addon2" onClick={goToLogin}>Sign In</Button> */}
                 <div>
                  {/* <a className='nav-sign-in'>Sign In</a> */}
                 </div>
